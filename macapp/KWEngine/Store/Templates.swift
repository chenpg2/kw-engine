//  Templates.swift
//  KWEngine — embedded copies of the kw-engine workspace templates so the app
//  can scaffold a knowledge base identical to `kw init` without external files.

import Foundation

enum Templates {

    static let extractTemplateVersion = "extract-template@v1"
    static let rubricVersion = "distill-rubric@v1"

    static let initialIndexJSON = #"""
{
  "version": 1,
  "counters": {
    "principle": 0
